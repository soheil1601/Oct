...
local service = msg.service
	if to == 'user' and msg.fwd_from then
		...
		text = "<b>User From Info:</b>\n\n<b>ID:</b><code> "..from_id.."</code><b>\nFirst:</b><code> "..from_first_name.."</code><b>\nLast: </b><code>"..from_last_name.."</code><b>\n<b>Username:</b><code> "..from_username.."</code>"
...
local function chat_list(msg)
    ...
    local message = '<b>List of Groups:</b>\n<b>Use </b><code>#join [ID]</code> <b>to join</b>\n\n'
...
if to == 'user' or service or is_admin1(msg) and to == "chat" or to == "channel" then
	if is_gbanned(msg.from.id) then
        return '⛔️ <b>You are globally banned.</b>'
	end
