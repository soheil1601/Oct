...
local function run(msg,matches)
    ...
    if matches[1] == "contactlist" then
      ...
      return "<b>I've sent contact list with both json and text format to your private</b>"
    end
    if matches[1] == "delcontact" then
      ...
      return "<b>User </b><code>"..matches[2].."</code><b> removed from contact list</b>"
    end
   ...
   return "<b>User With Phone</b> <code>+"..matches[2].."</code><b> has been added</b>"
end
 ...
 if matches[1] == "mycontact" and is_sudo(msg) then
    ...
    if matches[1] == "dialoglist" then
      ...
      return "<b>I've sent a group dialog list with both json and text format to your private messages</b>"
    end
	...
	if matches[1] == 'reload' then
		...
		return "♻️ <b>Successfully Reloaded!</b>"
	end
	--[[*For Debug*
	...
	if matches[1] == 'addlog' and not matches[2] then
		if is_log_group(msg) then
			return "<b>Already a Log_SuperGroup</b>"
		end
	...
	if matches[1] == 'remlog' and not matches[2] then
		if not is_log_group(msg) then
			return "<b>Not a Log_SuperGroup</b>"
		end
