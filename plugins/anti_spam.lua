  ...
  if msg.from.type == 'user' then
    ...
    if msgs > max_msg then
	  ...
	  if msg.to.type == 'user' then
		...
		if msgs >= max_msg then
			print("Pass2")
			send_large_msg("user#id"..msg.from.id, "⛔️ User ["..msg.from.id.."] blocked for spam.")
	  ...
	  if msg.to.type == 'chat' or msg.to.type == 'channel' then
		if username then
			...
			send_large_msg(receiver , "⛔️ <b>Flooding is locked</b>\n<b>-</b> @"..username.." <b>[</b><code>"..msg.from.id.."</code><b>]</b>\n<b>- User kicked</b>")
		else
			savelog(msg.to.id, name_log.." ["..msg.from.id.."] kicked for #spam")
			send_large_msg(receiver , "⛔️ <b>Flooding is locked</b>\n<b>- "..name_log.." [</b><code>"..msg.from.id.."</code><b>]</b>\n<b>- User kicked</b>")
		end
	  end
      -- incr it on redis
      ...
      if gbanspamonredis then
        if tonumber(gbanspamonredis) ==  4 and not is_owner(msg) then
          ...
          send_large_msg("chat#id"..msg.to.id, "⛔️ <b>User</b> ( "..name.. "["..msg.from.id.."] )<b> globally banned\n\n- Spamming</b>")
		  send_large_msg("channel#id"..msg.to.id, "⛔️ <b>User</b> ( " ..name.." ["..msg.from.id.."] )<b> globally banned\n\n- Spamming</b>")
          local GBan_log = 'GBan_log'
		  local GBan_log =  data[tostring(GBan_log)]
		  for k,v in pairs(GBan_log) do
			log_SuperGroup = v
			gban_text = "⛔️ User [ "..name.." ] ( @"..username.." )"..msg.from.id.."\n Globally banned from ( "..msg.to.print_name.." ) [ "..msg.to.id.." ]\n\n- Spamming"
